		  ...
		  <!--sdk sdhflsdkfhdfhpdsohgpiudghdrpsogherghearoghwrgowrhjgwe4otghwearogherog -->
			...
			<div class="pt-0 pb-50">
				...
				<div class="container">
					...
					<?php 
					if ($complogo == null) {
					print '<center><img class="autofit" alt="image"  src="images/blank.png"/></center>';
					}else{
					echo '<center><img class="autofit" alt="image"  src="data:image/jpeg;base64,'.base64_encode($complogo).'"/></center>';	
					}
					?>
					</div>
